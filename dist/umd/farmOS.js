(function (global, factory) {
  ...
  function _curry2$u(fn) {
    return function f2(a, b) {
      switch (arguments.length) {
        ...
        case 1:
          return _isPlaceholder$2(a) ? f2 : _curry1$f(function (_b) {
            return fn(a, _b);
          });

        default:
          return _isPlaceholder$2(a) && _isPlaceholder$2(b) ? f2 : _isPlaceholder$2(a) ? _curry1$f(function (_a) {
            return fn(_a, b);
          }) : _isPlaceholder$2(b) ? _curry1$f(function (_b) {
            return fn(a, _b);
          }) : fn(a, b);
      }
    };
  ...
  var omit =
  /*#__PURE__*/
  _curry2$t(function omit(names, obj) {
    var result = {};
    var index = {};
    var idx = 0;
  ...
  var append =
  /*#__PURE__*/
  _curry2$s(function append(el, list) {
    return _concat$1(list, [el]);
  });

  var append_1 = append;

  var append$1 = append_1;
  ...
  var _isArray$4 = Array.isArray || function _isArray(val) {
  ...
  function _dispatchable$5(methodNames, xf, fn) {
    return function () {
  ...
  var _dispatchable_1 = _dispatchable$5;

  function _isString$4(x) {
    return Object.prototype.toString.call(x) === '[object String]';
  }

  var _isString_1 = _isString$4;
  ...
  var _isArrayLike$3 =
  /*#__PURE__*/
  _curry1$e(function isArrayLike(x) {
    if (_isArray$2(x)) {
      return true;
    }
  ...
  var _forceReduced_1 = _forceReduced$1;
  ...
  var bind$4 =
  /*#__PURE__*/
  _curry2$r(function bind(fn, thisObj) {
  ...
  var preservingReduced = function (xf) {
    return {
      '@@transducer/init': _xfBase$4.init,
  ...
  var _flatCat$1 = function _xcat(xf) {
    ...
    return {
      ...
      '@@transducer/step': function (result, input) {
        return !_isArrayLike(input) ? _reduce$4(rxf, result, [input]) : _reduce$4(rxf, result, input);
      }
    };
  };

  var _flatCat_1 = _flatCat$1;

  function _map$2(fn, functor) {
    var idx = 0;
  ...
  var curryN$4 =
  /*#__PURE__*/
  _curry2$p(function curryN(length, fn) {
    if (length === 1) {
      return _curry1$d(fn);
    }
  ...
  var _xchain$1 =
  /*#__PURE__*/
  _curry2$n(function _xchain(f, xf) {
    return map$3(f, _flatCat(xf));
  });

  var _xchain_1 = _xchain$1;
  ...
  _curry2$m(
  /*#__PURE__*/
  _dispatchable$3(['fantasy-land/chain', 'chain'], _xchain, function chain(fn, monad) {
  ...
  function _curry3$6(fn) {
    return function f3(a, b, c) {
      switch (arguments.length) {
        ...
        case 1:
          return _isPlaceholder(a) ? f3 : _curry2$l(function (_b, _c) {
            return fn(a, _b, _c);
          });

        case 2:
          return _isPlaceholder(a) && _isPlaceholder(b) ? f3 : _isPlaceholder(a) ? _curry2$l(function (_a, _c) {
            return fn(_a, b, _c);
          }) : _isPlaceholder(b) ? _curry2$l(function (_b, _c) {
            return fn(a, _b, _c);
        ...
        default:
          return _isPlaceholder(a) && _isPlaceholder(b) && _isPlaceholder(c) ? f3 : _isPlaceholder(a) && _isPlaceholder(b) ? _curry2$l(function (_a, _b) {
            return fn(_a, _b, c);
          }) : _isPlaceholder(a) && _isPlaceholder(c) ? _curry2$l(function (_a, _c) {
            return fn(_a, b, _c);
          }) : _isPlaceholder(b) && _isPlaceholder(c) ? _curry2$l(function (_b, _c) {
            return fn(a, _b, _c);
          }) : _isPlaceholder(a) ? _curry1$b(function (_a) {
            return fn(_a, b, c);
          }) : _isPlaceholder(b) ? _curry1$b(function (_b) {
            return fn(a, _b, c);
          }) : _isPlaceholder(c) ? _curry1$b(function (_c) {
            return fn(a, b, _c);
          }) : fn(a, b, c);
      }
    };
  ...
  function pipe$1() {
    ...
    return _arity$1(arguments[0].length, reduce$2(_pipe, arguments[0], tail(arguments)));
  }
  ...
  var reverse$1 =
  /*#__PURE__*/
  _curry1$9(function reverse(list) {
    return _isString$2(list) ? list.split('').reverse().join('') : Array.prototype.slice.call(list, 0).reverse();
  });
  ...
  var _isFunction_1 = _isFunction$1;
  ...
  function _equals$1(a, b, stackA, stackB) {
    ...
    while (idx >= 0) {
      ...
      if (!(_has$2(key, b) && _equals$1(b[key], a[key], extendedStackA, extendedStackB))) {
        return false;
      }
  ...
  var equals$2 =
  /*#__PURE__*/
  _curry2$k(function equals(a, b) {
    return _equals(a, b, [], []);
  });

  var equals_1 = equals$2;

  var equals$3 = equals_1;
  ...
  function () {
    ...
    XFilter.prototype['@@transducer/init'] = _xfBase$2.init;
    XFilter.prototype['@@transducer/result'] = _xfBase$2.result;
  ...
  var _xfilter$1 =
  /*#__PURE__*/
  _curry2$j(function _xfilter(f, xf) {
  ...
  _curry2$i(
  /*#__PURE__*/
  _dispatchable$2(['filter'], _xfilter, function (pred, filterable) {
  ...
  var reject$1 =
  /*#__PURE__*/
  _curry2$h(function reject(pred, filterable) {
  ...
  function _toString$1(x, seen) {
    var recur = function recur(y) {
      ...
      return _includes(y, xs) ? '<Circular>' : _toString$1(y, xs);
  ...
  var toString$2 =
  /*#__PURE__*/
  _curry1$7(function toString(val) {
  ...
  var evolve =
  /*#__PURE__*/
  _curry2$f(function evolve(transformations, object) {
  ...
  var mapObjIndexed =
  /*#__PURE__*/
  _curry2$e(function mapObjIndexed(fn, obj) {
  ...
  var nth$1 =
  /*#__PURE__*/
  _curry2$d(function nth(offset, list) {
  ...
  var paths$1 =
  /*#__PURE__*/
  _curry2$c(function paths(pathsArray, obj) {
  ...
  var path$1 =
  /*#__PURE__*/
  _curry2$b(function path(pathAr, obj) {
  ...
  var replace =
  /*#__PURE__*/
  _curry3$3(function replace(regex, replacement, str) {
  ...
  var dissoc =
  /*#__PURE__*/
  _curry2$9(function dissoc(prop, obj) {
    var result = {};
  ...
  var pick =
  /*#__PURE__*/
  _curry2$8(function pick(names, obj) {
    var result = {};
    var idx = 0;
  ...
  var addIndex =
  /*#__PURE__*/
  _curry1$5(function addIndex(fn) {
  ...
  var clone =
  /*#__PURE__*/
  _curry1$4(function clone(value) {
  ...
  var pluck$1 =
  /*#__PURE__*/
  _curry2$6(function pluck(p, list) {
  ...
  var anyPass =
  /*#__PURE__*/
  _curry1$2(function anyPass(preds) {
    return curryN(reduce$1(max$1, 0, pluck('length', preds)), function () {
      var idx = 0;
  ...
  var hasPath$1 =
  /*#__PURE__*/
  _curry2$5(function hasPath(_path, obj) {
    ...
    while (idx < _path.length) {
      if (!isNil(val) && _has$1(_path[idx], val)) {
        val = val[_path[idx]];
        idx += 1;
      } else {
        return false;
  ...
  var has =
  /*#__PURE__*/
  _curry2$4(function has(prop, obj) {
  ...
  const hasAny = compose$1(anyPass$1, map$5(has$1));
   ...
   * @returns {Array.<T>}
  */
  const mapIndexed = addIndex$1(map$5);
  ...
  const getDefinition = (schema, pointer) => {
    ...
    const subschema = path$2(pathSegments, schema);
  ...
  const getProperties = (schema) => {
    ...
    if (hasLogicalKeyword(schema)) {
      ...
      if (keyword === 'not') {
        return map$5(p => ({ not: p }), getProperties(schema.not));
      }
  ...
  const dropMilliseconds = replace$1(/\.\d\d\d/, '');
  ...
  const removeDrupalMetaSchemas = drupalFields => evolve$1({
    properties: omit$1(drupalFields),
    required: filter$2(field => !drupalFields.includes(field)),
  });
  ...
  const transformD9Schema = entName => (d9Schema) => {
    ...
    const transformAttributeFields = evolve$1({
      properties: mapObjIndexed$1((subschema, propName) => {
        ...
        const standardDefault = path$2([entName, propName], attributeDefaults);
        if (!standardDefault) return subschema;
        return { ...subschema, default: standardDefault };
      }),
    });
    const transformRelationshipFields = evolve$1({
      properties: map$5(transformResourceSchema),
    });
    const transformAttributesSchema = compose$1(
      transformAttributeFields,
      removeDrupalMetaSchemas(drupalMetaFields.attributes),
    );
    const transformRelationshipsSchema = compose$1(
  ...
  const transformLocalEntity = (entName, data) => compose$1(
    dissoc$1('meta'),
    evolve$1({
      type: t => `${entName}--${t}`,
      attributes: { timestamp: dropMilliseconds },
      relationships: map$5(r => ({ data: r })),
    }),
  )(data);

  const transformRemoteAttributes = compose$1(
    evolve$1({ timestamp: safeIso }),
    omit$1(drupalMetaFields.attributes),
  );
  const transformRemoteRelationships = compose$1(
    map$5(prop$2('data')),
    omit$1(drupalMetaFields.attributes),
  );
  const makeFieldChanges = (attrs, rels) => ({
    ...map$5(() => safeIso(attrs.changed), omit$1(drupalMetaFields.attributes, attrs)),
    ...map$5(() => safeIso(rels.changed), omit$1(drupalMetaFields.relationships, rels)),
  });
  ...
  const transformRemoteEntity = (entName, setLastSync = false) => ({
    ...
    meta: {
      ...
      remote: {
        ...
        meta: {
          attributes: pick$1(drupalMetaFields.attributes, attributes),
          relationships: pick$1(drupalMetaFields.relationships, relationships),
        },
      },
    },
  ...
  const transformFetchResponse = name => evolve$1({
    data: map$5(transformRemoteEntity(name)),
  });

  const transformSendResponse = name => compose$1(
  ...
  const aggregateBundles = reduce$4((aggregate, result) => {
    const { reason, value, status } = result;
    if (status === 'fulfilled') {
      const nextData = chain$1(path$2(['data', 'data']), value);
      return evolve$1({
        data: concat$1(nextData),
        fulfilled: concat$1(value),
      }, aggregate);
    }
    return evolve$1({
      rejected: append$1(reason),
    }, aggregate);
  ...
  function adapter(model, opts) {
    ...
    const chainRequests = (req, limit, prev = [], total = 0) => req.then((res) => {
      let next = path$2(['data', 'links', 'next', 'href'], res);
      const resLength = path$2(['data', 'data', 'length'], res);
    ...
    return {
      ...
      schema: {
        fetch(entName, type) {
          return connection.schema.fetch(entName, type)
            .then((schemata) => {
              if (!entName) {
                return mapObjIndexed$1(
                  (entitySchemata, entityName) => map$5(
              ...
              if (!type) {
                return map$5(transformD9Schema(entName), schemata);
              }
      ...
      ...entityMethods(({ nomenclature: { name, shortName } }) => ({
        ...
        fetch: ({ filter, limit }) => {
          ...
          const handleBundleResponse = compose$1(
  ...
  var _xtake$1 =
  /*#__PURE__*/
  _curry2$3(function _xtake(n, xf) {
  ...
  const eqFields = fieldType =>
    (fieldType === 'relationships' ? eqBy$1(relsTransform) : equals$3);
  ...
  function farmOS(farmConfig) {
    ...
    const addRemote = (remoteConfig = {}) => {
      ...
      farm.remote = { ...omit$1(shortNames, connection), add: addRemote };
    };
